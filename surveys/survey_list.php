...
{#records exist - process
	if($myPager->showTotal()==1){$itemz = "survey";}else{$itemz = "surveys";}
		echo '<table align="center" border="3" style="border-collapse:collapse" cellpadding="3" cellspacing="3" style="color: green;">';
		echo '<tr>
				<th>Admin Name</th>
				<th>Title</th>
				<th>Description</th>
